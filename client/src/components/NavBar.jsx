  ...
  return (
    <nav className="bg-gray-800">
        <div className="px-5 md:flex md:flex-row md:justify-between">
          ...
          {/* nav links: on mobile, nav links are displayed vertically when toggling the menu. This is achieved by using an absolute position, z-index and open state variable  */}
          ...
          <div className={
            ...
            <ul
              className="flex flex-col md:flex-row list-none pb-8 md:pb-0"
            >
